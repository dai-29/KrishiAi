...
function Footer() {
  return (
    <footer id="contact-section" className="navbar navbar-expand-lg navbar-dark bg-success text-white pt-5 pb-4">
      ...
      <div className="container text-center text-md-start">
        <div className="row text-center text-md-start">
          ...
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            <h5 className="text-uppercase mb-4 fw-bold">KrishiAI</h5>
            <p>
