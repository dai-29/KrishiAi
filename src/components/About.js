      ...
      <div className="container">
        <div className="row gx-5">
          ...
          <div className="col-lg-6 pb-5">
            ...
            <p className="mb-4">
              Tempor erat elitr at rebum at at clita. Diam dolor diam ipsum et tempor sit. Clita erat ipsum et lorem et sit, 
              sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet magna
            </p>
